...
```{r fig1_gplot2, eval=FALSE, eval=FALSE}
...
```{r fig2_gplot2, eval=FALSE, eval=FALSE}
l + geom_line()
```
...
```{r fig3_gplot2, warning=FALSE, eval=FALSE}
l + geom_point()
```
...
```{r fig4_gplot2, warning=FALSE, eval=FALSE}
...
```{r fig5_gplot2, warning=FALSE, eval=FALSE}
...
```{r fig6_gplot2, warning=FALSE, eval=FALSE}
l2 <- l1+ geom_area() +
...
```{r fig7_gplot2, warning=FALSE, eval=FALSE}
...
```{r fig8_gplot2, warning=FALSE, eval=FALSE}
l2 + geom_rug(sides = "l")
```
...
```{r fig9_gplot2, warning=FALSE, eval=FALSE}
...
```{r fig10_gplot2, warning=FALSE, eval=FALSE}
co + geom_smooth()
```
...
```{r fig11_gplot2, warning=FALSE, eval=FALSE}
...
```{r fig12_gplot2, warning=FALSE, eval=FALSE}
co + geom_smooth(se = FALSE) + 
...
```{r fig13_gplot2, warning=FALSE, eval=FALSE}
...
```{r fig30_gplot2, warning=FALSE, eval=FALSE}
...
```{r  fig32_gplot2, warning=FALSE, eval=FALSE}
